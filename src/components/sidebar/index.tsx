...
import PlaygroundLogo from '../logo';
import { cn } from '~/lib/utils';

export const Sidebar = () => {
  const { activeKey, isOpen, setActiveKey, setIsOpen } = useSidebar();
  return (
    <div className='h-screen border-r border-neutral-200 dark:border-neutral-700'>
      <PlaygroundLogo />
